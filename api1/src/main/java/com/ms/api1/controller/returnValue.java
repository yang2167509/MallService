...
//    private int servicePort;
    ...
    private static final Logger logger = LoggerFactory.getLogger(returnValue.class);



    @Pointcut("execution(* com.ms.controller..*(..))") //C:\Users\gujiawei\Desktop\sw-ms5\goods-service-8004\src\main\java\com\ms\controller\goodsController.java
...
//        String format = sdf.format(System.currentTimeMillis());
//        System.out.println("入库时间"+sdf.format(System.currentTimeMillis()));
...
//        jdbcTemplate.update("insert into test02 (returnvalue, create_time) values (?, ?)", returnValue, new Date());
//        jdbcTemplate.update("insert into return4(service_name,className,methodName,path,return_value,create_time,inserted_by) values (?,?,?,?,?,?,?)",
//                moduleName,className,methodName,path,returnValue,format,inserted_by
//        );
