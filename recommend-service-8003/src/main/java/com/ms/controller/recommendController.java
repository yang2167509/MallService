...
public class recommendController {
    ...
    @RequestMapping("/autoGetRecommendInfo")
    public String autoGetRecommendInfo(){

//        String str = getStr("goods-service");
        String str="8004";

//        String url = "http://192.168.100.26:"+str+"/checkGoodsDetail";
//        String url = "http://localhost:"+str+"/checkGoodsDetail";
        String url = "http://goods-service-8004:8004/checkGoodsDetail";

        String gdRes = restTemplate.getForObject(url, String.class);
...
// 生成一个随机的毫秒数，范围从 0 到 999（包含）
        ...
        return "auto Get Recommend Info.<br/>"+gdRes;
    }
